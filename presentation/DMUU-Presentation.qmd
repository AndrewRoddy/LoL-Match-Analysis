...
```
This graph compares Damage Dealt with Damage Taken aquired throughout the game.
...
```
This graph compares Damage Dealt with Total Gold aquired throughout the game.
...
```
This graph compares Damage Dealt with Minions Killed during the game.
...
```
Note the different graph scales and TurretDmgDealt is meant to be Turret's Downed.
Takeway : Players that destroy towers are less likely to deal a lot of damage.
